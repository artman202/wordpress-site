<?php /* Template Name: Application Development Portfolio Template */ ?>
            ...
            ?>
                <div class="col-md-6 our-work-blocks">
                    <a class="port-triangle-wrapper" data-toggle="modal">
                        <img class="port-triangle-logo bg-red" src="<?php echo get_template_directory_uri() ?>/images/coming-soon.svg" alt="">
                    </a>
